...
execute unless score AllowTeleportInCombat SpawnSettings matches 1 if score @s IsInCombat matches 1 run tellraw @s {"storage": "cootshk:combatlog", "nbt": "TeleportInCombat", "interpret": true}
